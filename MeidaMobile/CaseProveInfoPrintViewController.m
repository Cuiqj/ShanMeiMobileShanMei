...
- (void)pageLoadInfo
{
    ...
    if ([self.caseProveInfo.case_short_desc isEqualToString:@"造成公路路面损坏、造成公路路面污染"]) {
        self.textcase_short_desc.text = @"造成公路路面损坏及污染";
    }else if ([self.caseProveInfo.case_short_desc isEqualToString:@"损坏公路附属设施、造成公路路面损坏、造成公路路面污染"]){
        self.textcase_short_desc.text = @"损坏公路附属设施、造成公路路面损坏及污染";
    }
    else{
        self.textcase_short_desc.text = self.caseProveInfo.case_short_desc;
    }
