    ...
    if (!isBlank) {
        ...
        if (temp.count>0) {
            ...
            for (int i             = 0; i<recordArray.count; i++) {
                ...
                CGFloat width2 = 486;//原本是492，编号之后是“.”现在修改为“、”长度是汉字的长度，多了6
                if (i + 1 >= 10){
                    width2         = width2 - 6;
                }
                if (i + 1 >= 100){
                ...
                while (![hangStrings.handleString isEmpty]) {
                    ...
                    tempStr     = [NSString stringWithFormat:@"%@%@\r\n", tempStr,hangStrings.returnString ];
                }
            ...
            pathString                  = [[NSString alloc] initWithFormat:@"%@交班%@，%@结束巡查",[formatter stringFromDate:inspection.time_start],pathString,[formatter stringFromDate:inspection.time_end]];
